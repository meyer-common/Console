...
public class FileConsoleParameterTests
{
    ...
    public void CanParseFilePath()
    {
        ...
        var mapped = parameter.PerformMapping(new LinkedList<string>($"-f {Environment.CurrentDirectory}/Meyer.Common.Console.dll".Split(' ')));
    ...
    public void CanParseRelativePath()
    {
        ...
        var mapped = parameter.PerformMapping(new LinkedList<string>($"-f .{Path.DirectorySeparatorChar}Meyer.Common.Console.dll".Split(' ')));
    ...
    public void NotPresentDoesNotPerformAction()
    {
        ...
        var mapped = parameter.PerformMapping(new LinkedList<string>("".Split(' ')));
    ...
    public void CanParseFirstParameter()
    {
        ...
        var mapped = parameter.PerformMapping(new LinkedList<string>($"-f {Environment.CurrentDirectory}/Meyer.Common.Console.dll -aaa sadfsdf".Split(' ')));
    ...
    public void CanParseMiddleParameter()
    {
        ...
        var mapped = parameter.PerformMapping(new LinkedList<string>($"-aaa asdfsad -f {Environment.CurrentDirectory}/Meyer.Common.Console.dll -b -i 5 -bbb sdfasdf".Split(' ')));
    ...
    public void CanParseLastParameter()
    {
        ...
        var mapped = parameter.PerformMapping(new LinkedList<string>($"-aaa asdfsad -b -f {Environment.CurrentDirectory}/Meyer.Common.Console.dll".Split(' ')));
    ...
    public void CanParseMultiple()
    {
        ...
        var mapped = parameter.PerformMapping(new LinkedList<string>($"-f {Environment.CurrentDirectory}/Meyer.Common.Console.dll -f {Environment.CurrentDirectory}/Meyer.Common.Console.pdb".Split(' ')));
    ...
    public void ArgsRemovedOnSuccess()
    {
        ...
        var mapped = parameter.PerformMapping(args);
