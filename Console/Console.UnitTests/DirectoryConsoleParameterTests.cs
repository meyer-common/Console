...
public class DirectoryConsoleParameterTests
{
    ...
    public void CanParseDirectoryPath()
    {
        ...
        var mapped = parameter.PerformMapping(new LinkedList<string>($"-d {Environment.CurrentDirectory}".Split(' ')));
    ...
    public void CanParseRelativePath()
    {
        ...
        var mapped = parameter.PerformMapping(new LinkedList<string>($"-d .".Split(' ')));
    ...
    public void CanParseFirstParameter()
    {
        ...
        var mapped = parameter.PerformMapping(new LinkedList<string>($"-d {Environment.CurrentDirectory} -aaa sadfsdf".Split(' ')));
    ...
    public void CanParseMiddleParameter()
    {
        ...
        var mapped = parameter.PerformMapping(new LinkedList<string>($"-aaa asdfsad -d {Environment.CurrentDirectory} -b -i 5 -bbb sdfasdf".Split(' ')));
    ...
    public void CanParseLastParameter()
    {
        ...
        var mapped = parameter.PerformMapping(new LinkedList<string>($"-aaa asdfsad -b -d {Environment.CurrentDirectory}".Split(' ')));
    ...
    {
        var dirInfos = new HashSet<DirectoryInfo>();

        var parameter = new DirectoryConsoleParameter(new[] { "d" }, x => dirInfos.Add(x), "");

        var mapped = parameter.PerformMapping(new LinkedList<string>($"-d {Environment.CurrentDirectory} -d {Environment.CurrentDirectory}".Split(' ')));
